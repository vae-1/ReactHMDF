...
def parse_arg():
    ...
    # Param
    parser.add_argument('--data-dir', default="/home/lqc/test/data", type=str, help="dataset path")
    parser.add_argument('--pred-dir', default="/home/lqc/test/data/outputs_avs2/Gmm-logs", type=str, help="the path of saved predictions")
